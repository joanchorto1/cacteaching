...
const submitForm = () => {
    ...
    Inertia.post(route('videos.store'), data.form);
}
</script>
...
<template>
    ...
    <div class="max-w-md mt-24 mx-auto">
        <form @submit.prevent="submitForm"  >
            ...
            <div class="mb-4">
                <label class="block text-white text-sm font-bold mb-2" for="serie_id">
                    Serie
                </label>
                <select class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="serie_id" v-model="data.form.serie_id" required>
