...
const submitForm = () => {
    Inertia.post(route('serie.store'), data.form);
}
</script>
    ...
    <div class="max-w-md mt-24 mx-auto">
        <form @submit.prevent="submitForm">
            ...
            <div class="mb-4">
                ...
                <input class="file:border-red-600  file:rounded-xl file:px-2 file:font-bold file:text-red-800 file:py-1 file:border-2 file:bg-white  appearance-auto border rounded w-full py-2 px-3 text-gray-100 leading-tight focus:outline-none focus:shadow-outline" id="imagen" type="file"  @change="handleFileChange" required>
            </div>
